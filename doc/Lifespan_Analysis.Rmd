...
setwd("/Users/nmounier/Documents/SGG/Projects/Packaging/Lifespan_v1.0.0")
...
`r nrow(extract_results_bGWAS(Lifespan_bGWAS))` of them are missed by the conventional GWAS (using same p-value threshold of 5e-8 to call significance).
...
Should we also look at non significant SNPs (based on BFs) but with significant direct effects? -> create a function to extract SNPs having significant direct (posterior) SNPs independently of prior/BFs?
